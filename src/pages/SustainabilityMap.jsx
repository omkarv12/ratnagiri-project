...
function MapLegend() {
  return (
    <div className="hidden md:flex absolute top-4 right-4 z-20 bg-white/95 backdrop-blur rounded-xl shadow-lg border border-slate-200 p-3 flex-col gap-1.5 max-w-[190px]">
